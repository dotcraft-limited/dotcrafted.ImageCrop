            ...
            return declare('dotcrafted.Editors.ImageReferenceSelector',
                ...
                ],
                {
                    ...
                    _onImageEditorDialogHide: function (evt) {
                        ...
                        focusManager.focus(this.button.domNode);
                    },

                    _onImageEditorDialogExecute: function () {

                        var value = lang.clone(this.selectedMedia, true);
